...
{
    /// <inheritdoc />
    public partial class AddGrainMixingProcess : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalHoursWorked = table.Column<double>(type: "float(18)", precision: 18, scale: 6, nullable: false),
                    LaborProductivity = table.Column<double>(type: "float(18)", precision: 18, scale: 6, nullable: false),
