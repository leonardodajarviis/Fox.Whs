...
/// <summary>
/// API quản lý danh sách Máy tua từ SAP
/// </summary>
[ApiController]
[Route("api/rewinding-machines")]
[Authorize]
public class RewindingMachineController : ControllerBase
{
    private readonly AppDbContext _dbContext;

    public RewindingMachineController(AppDbContext sapDbContext)
    {
